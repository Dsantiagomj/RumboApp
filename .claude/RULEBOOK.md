...
_Philosophy: Zero Shortcuts - Build it RIGHT from day one 💪_
...
**Context:** Colombia (Bogotá, Medellín, Cali) - Economic pressure, tight budgets
...
1. **[CODE_STANDARDS.md](../.rumbo/CODE_STANDARDS.md)** ⭐ **MANDATORY**
...
│   └── RULEBOOK.md          # This file (PROJECT LAW)
├── .rumbo/                  # Project documentation (DO NOT DELETE)
│   ├── CODE_STANDARDS.md    # ⭐ CODE STRUCTURE & BEST PRACTICES (MANDATORY)
...
## 📐 CODE STANDARDS (Critical Rules)

**⚠️ CRITICAL: Read [.rumbo/CODE_STANDARDS.md](../.rumbo/CODE_STANDARDS.md) BEFORE writing ANY code**
...
- ✅ USE barrels: `components/ui/`, `lib/`, `types/`
- ❌ NO barrels: `features/` (kills tree-shaking)
...
**Colombian Stores (v3):** Éxito, Carulla, D1, Ara, Olímpica
...
## 🏆 PRODUCTION-GRADE PHILOSOPHY (Zero Shortcuts)
...
- ✅ Monitoring (Sentry, Plausible, Axiom)
- ✅ Performance budget (Lighthouse 90+ enforced)
...
- ✅ User data ownership
- ✅ No Google Analytics (Plausible/Umami)
- ✅ GDPR compliant
- ✅ Self-hosted deployment option

**4. Feature-Complete for YOUR Use Case**

- ✅ All features YOU need working perfectly
- ✅ Not "functional" - POLISHED
- ✅ Colombian context (COP, stores, banks)
...
- **`.rumbo/`** → Project architecture, code standards, technical requirements
- **`.claude/`** → Maestro-specific references, workflow rules, temporal plans
- **`.github/`** → Public-facing docs that GitHub displays to contributors
...
**For detailed code patterns, read:** `.rumbo/CODE_STANDARDS.md` ⭐
